...
try: app_id = int(os.environ.get("app_id", "24506543"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "d83760fbc6b2b4602d6f729c63d06f27")
...
try: custom_caption = os.environ.get("custom_caption", "`{file name}`JOIN❤️ @op_movies_club")
...
about_message = """
<b>• Name : <a href=https://t.me/op_movies_club>VJ AutoCaptionnnn</a></b>
<b>• Developer : <a href=https://t.me/VJ_Botz>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/op_movies_club>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/op_movies_club"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/opmoviescaptionbot?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/op_movies_club")
